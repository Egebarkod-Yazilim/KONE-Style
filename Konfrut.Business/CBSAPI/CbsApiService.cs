                ...
                try
                {
                    ...
                    if (districts.Count > 0)
                    {
                        ...
                        foreach (var district in districts)
                        {
                            ...
                            var districtCoordinates = await _unitOfWork.Coordinates.GetAllAsync(c => c.EntityName == "District" && c.EntityId == district.Id.ToString());
                    ...
                    else
                    {
                        ...
                        foreach (var district in serializedObject.features)
                        {
                            ...
                            {
                                var addDistrict = await _unitOfWork.District.AddAsync(new Entity.Concrete.District()
                                {
                                    ...
                                    if (district.geometry.type == "Polygon")
                                    {
                                        foreach (var provinceCoordinates in district.geometry.coordinates)
                                        {
                                            ...
                                            foreach (var coordi in provinceCoordinates)
                                            {
                                                ...
                                                {
                                                    EntityName = "District",
                                                    EntityId = addDistrict.Id.ToString(),
                                                    CreatedByName = "SYSTEM",
                                                    ModifiedByName = "SYSTEM",
                                                    CreatedDate = DateTime.Now,
                                                    ModifiedDate = DateTime.Now,
            ...
            using (HttpClient client = new HttpClient())
            {
                ...
                try
                {
                    ...
                    if (villages.Count > 0)
                    {
                        ...
                        {
                            var villageCoordinates = await _unitOfWork.Coordinates.GetAllAsync(c => c.EntityName == "Village" && c.EntityId == village.Id.ToString());
                                ...
                                singleCoordinate.Add(new List<double>
                        {
                            ...
                            returnModel.features.Add(new VillageReturnModel.Feature()
                            {
                                ...
                                {
                                    type = coordinateType,
                                    coordinates = new List<List<List<double>>> { singleCoordinate }
                                }
                            });
                    ...
                    else
                    {
                        ...
                        foreach (var village in serializedObject.features)
                        {
                            ...
                            {
                                var addVillage = await _unitOfWork.Village.AddAsync(new Entity.Concrete.Village()
                                {
                                    CreatedDate = DateTime.Now,
                                    ModifiedDate = DateTime.Now,
                                    IsDeleted = false,
                                    ...
                                    if (village.geometry.type == "Polygon")
                                    {
                                        foreach (var villageCoordinates in village.geometry.coordinates)
                                        {
                                            ...
                                            foreach (var coordi in villageCoordinates)
                                            {
                                                ...
                                                {
                                                    EntityName = "Village",
                                                    EntityId = addVillage.Id.ToString(),
                                                    CreatedByName = "SYSTEM",
                                                    ModifiedByName = "SYSTEM",
                                                    CreatedDate = DateTime.Now,
                                                    ModifiedDate = DateTime.Now,
