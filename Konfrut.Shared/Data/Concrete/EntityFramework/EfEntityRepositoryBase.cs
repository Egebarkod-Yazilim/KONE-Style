...
namespace Konfrut.Shared.Data.Concrete.EntityFramework
{
        ...
        where TEntity : class, IEntity, new()
    {
        ...
        public async Task DeleteAllAsync(List<TEntity> entity)
        {
        ...
        public async Task<IList<TEntity>> GetAllPagedAsync(int pageNumber = 1, int pageSize = int.MaxValue, Expression<Func<TEntity, bool>>? predicate = null, params Expression<Func<TEntity, object>>[] includeProperties)
        {
        ...
        public async Task<TEntity> UpdateAsync(TEntity entity)
        {
            ...
            await Task.Run(() => { _context.Entry<TEntity>(entity).State = EntityState.Modified; _context.Set<TEntity>().Update(entity); });
            return entity;
        }
        ...
        public List<TEntity> DeleteRangeAsync(List<TEntity> entities)
        {
