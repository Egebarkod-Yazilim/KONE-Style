...
namespace Konfrut.KOne.WebUI.Controllers
{
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> GetDistrictCoordinates(int districtId)
        {
            ...
            if (district != null)
            {
                var provinceCoordinates = await _unitOfWork.Coordinates.GetAllAsync(c => c.EntityName == "District" && c.EntityId == district.Id.ToString());
        ...
        public async Task<IActionResult> GetProvinceCoordinates(int provinceId)
        {
            ...
            if (province != null)
            {
                var provinceCoordinates = await _unitOfWork.Coordinates.GetAllAsync(c => c.EntityName == "Province" && c.EntityId == province.Id.ToString());
